...
class GroupAdapter(val context:Context , val messageList:ArrayList<Message>): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (holder.javaClass == SentViewHolder::class.java){
            ...
            holder.sentMessage.setText("${messageList.get(position).username} : ${currentMessage.message}")

        }else{

            val viewHolder = holder as ReceiveViewHolder
            holder.receiveMessage.setText("${messageList.get(position).username} : ${currentMessage.message}")
